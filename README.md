...
| [13-example-join.yaml](examples/13-example-join.yaml)                                       | Joins live sensor data (stream) with alert-settings (table) and produces individual alert records for each threshold breach                                                                                                        |
